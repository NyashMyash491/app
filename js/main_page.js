...
let PRICES = [100, 120, 1000, 15, 18, 112, 1512, 1555]
let IDS = [0, 1, 2, 3, 4, 5, 6, 7]
let IMGS = ['static/img/mango1.png','static/img/mango2.png', 'static/img/mango3.png', 'static/img/mango4.png', 'static/img/mango5.png', 
'static/img/mango6.png', 'static/img/mango7.png', 'static/img/mango8.png']

let catalog = {
   items: [],
   container: '.mango_people',
   cart: null,
   construct (cart) {
       this.cart = cart
       this._init () 
   ...
   render () {
       ...
       this.items.forEach (item => {
           ...
           <div class="product_name">
                   ...
                   <p class="mango_red">$${item.price}</p>
                   <button 
                       class="buy-btn" 
                       name="buy-btn"
