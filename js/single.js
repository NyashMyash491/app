 ...
 let PRICES = [100, 120, 130, 150]
 let IDS = [0, 1, 2, 3]
 let IMGS = ['static/img/mango2.png', 'static/img/mango4.png', 'static/img/mango5.png', 'static/img/single_page_product4.png']

 let catalog = {
     items: [],
     container: '.alsoLike__product-box',
     cart: null,
     construct(cart) {
         this.cart = cart
